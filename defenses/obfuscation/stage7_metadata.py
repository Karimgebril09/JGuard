...
class ObfuscationStage7Packager:
    """Build a provenance envelope from all prior stage outputs."""
    ...
    def package(
        ...
        *,
        ...
        transformations = self._collect_transformations(s2, s3, s4, s5, s6)
        ...
        risk_score = self._compute_risk_score(transformations, anomalies)
...
def package_stage7(
    *,
    ...
    """Convenience wrapper for stage-7 provenance packaging."""

    return ObfuscationStage7Packager().package(
        canonical_input=canonical_input,
        stage1_profile=stage1_profile,
        stage2_decoded=stage2_decoded,
        stage3_normalized=stage3_normalized,
        stage4_resolved=stage4_resolved,
        stage5_defragmented=stage5_defragmented,
    )
