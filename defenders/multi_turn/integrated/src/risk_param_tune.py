...
if __name__ == "__main__":
    ...
    print("\nBest correlation:", round(study.best_value, 4))
    print("Best params:")
    ...
    print("\nSaved parameters to:")
    print("defenders/multi_turn/integrated/config/optimized_params_risk(6).json")